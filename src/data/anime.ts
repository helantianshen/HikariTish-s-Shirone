...
export const animeData: AnimeItem[] = [
	...
	{
		title: "总之就是非常可爱 第二季",
		cover: "/assets/anime/covers/tonikawa-s2.webp",
		link: "https://bgm.tv/subject/355798",
		status: "watching",
		rating: 0,
		progress: { watched: 2, total: 12 },
		description: "新婚生活继续展开，司与星空迎来更多日常。",
		year: "2023",
		studio: "Seven Arcs",
		genres: ["恋爱", "喜剧", "日常"],
		identity: { provider: "bangumi", subjectId: "355798" },
	},
	{
		title: "86 -不存在的战区-",
		cover: "/assets/anime/covers/86-eighty-six.webp",
		link: "https://bgm.tv/subject/302189",
		status: "watching",
		rating: 0,
		progress: { watched: 8, total: 11 },
		description: "在被剥夺人权的战场上，少年少女为生存而战。",
		year: "2021",
		studio: "A-1 Pictures",
		genres: ["科幻", "战争", "机战"],
		identity: { provider: "bangumi", subjectId: "302189" },
	},
	{
		title: "前辈是男孩子",
	...
	},
	{
		...
		cover: "/assets/anime/covers/mushoku-tensei.webp",
		link: "https://bgm.tv/subject/277554",
		status: "planned",
		rating: 0,
		progress: { watched: 0, total: 11 },
		description: "转生到剑与魔法世界后，鲁迪乌斯决心认真生活。",
		year: "2021",
		studio: "Studio Bind",
		genres: ["异世界", "奇幻", "冒险"],
		identity: { provider: "bangumi", subjectId: "277554" },
	},
	{
		title: "魔王的女儿太温柔了！！",
		cover: "/assets/anime/covers/maou-musume.webp",
		link: "https://bgm.tv/subject/565416",
		status: "planned",
		rating: 0,
		progress: { watched: 0, total: 12 },
		description: "魔王的女儿因为过分温柔，让魔界的侵略计划彻底改变。",
		year: "2026",
		studio: "EMTスクエアード",
		genres: ["奇幻", "日常", "喜剧"],
		identity: { provider: "bangumi", subjectId: "565416" },
	},
	{
		title: "重启人生的千金小姐正在攻略龙帝陛下",
		cover: "/assets/anime/covers/yarinaoshi-reijou.webp",
		link: "https://bgm.tv/subject/432597",
		status: "planned",
		rating: 0,
		progress: { watched: 0, total: 12 },
		description: "重获人生的军神千金向前世最大的敌人发起攻略。",
		year: "2024",
		studio: "J.C.STAFF",
		genres: ["恋爱", "奇幻", "喜剧"],
		identity: { provider: "bangumi", subjectId: "432597" },
	},
	{
		title: "魔女之旅",
		cover: "/assets/anime/covers/majo-no-tabitabi.webp",
		link: "https://bgm.tv/subject/292970",
		status: "planned",
		rating: 0,
		progress: { watched: 0, total: 12 },
		description: "见习魔女伊蕾娜踏上随心而行的旅途。",
		year: "2020",
		studio: "C2C",
		genres: ["奇幻", "冒险", "治愈"],
		identity: { provider: "bangumi", subjectId: "292970" },
	},
];
